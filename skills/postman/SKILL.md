---
name: postman
description: Rules and proven patterns for managing Postman collections, workspaces, environments, specs, and automated API tests via the Postman MCP tools. Load this before creating/updating collections, running collection tests, generating collections from OpenAPI specs, or syncing code with Postman through agy.
---
